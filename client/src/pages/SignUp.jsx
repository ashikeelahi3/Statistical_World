      ...
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-sm mt-5'>
            This is a Statistical Resource Blog. You can sign up with your email and password or with Google
          </p>
        </div>
        {/* Right */}
        <div className='flex-1'>
          <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            <Button className='px-10' gradientDuoTone='purpleToPink' type='submit' disabled={loading} >
              {
                loading ? (
                  <>
                    <Spinner size='sm' />
